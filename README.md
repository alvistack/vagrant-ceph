...
-[![Vagrant Box
download](https://img.shields.io/badge/dynamic/json?label=alvistack%2Fceph-20.2&query=%24.boxes%5B%3A1%5D.downloads&url=https%3A%2F%2Fapp.vagrantup.com%2Fapi%2Fv1%2Fsearch%3Fq%3Dalvistack%2Fceph-20.2)](https://app.vagrantup.com/alvistack/boxes/ceph-20.2)
...
- [`alvistack/ceph-20.2`](https://app.vagrantup.com/alvistack/boxes/ceph-20.2)
  - [`packer/ceph-20.2-libvirt/packer.json`](https://github.com/alvistack/vagrant-ceph/blob/master/packer/ceph-20.2-libvirt/packer.json)
  - [`ceph-20.2-virtualbox/packer.json`](https://github.com/alvistack/vagrant-ceph/blob/master/packer/ceph-20.2-virtualbox/packer.json)
...
directory](https://learn.hashicorp.com/tutorials/vagrant/getting-started-project-setup?in=vagrant/getting-started):
    ...
    Vagrant.configure('2') do |config|
      config.vm.hostname = 'ceph-20.2'
      config.vm.box = 'alvistack/ceph-20.2'
...
[Libvirt](https://libvirt.org/) installed, e.g.
    ...
    # Run Molecule on Ceph 20.2
    molecule converge -s ceph-20.2-libvirt
